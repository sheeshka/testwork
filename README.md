...
При разработке использовался Claude Code (Anthropic) для следующих задач:

- **Unit-тесты** — генерация моков, фикстур и тестовых сценариев
- **Документация** — mermaid-диаграммы, описания таблиц и архитектурных решений
- **Сверка с ТЗ** — систематическая проверка соответствия требованиям
- **Код-ревью** — поиск несоответствий, некорректных HTTP-кодов и пропущенной валидации
